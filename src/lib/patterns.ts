...
export const PATTERNS: Pattern[] = [
  ...
  {
    id: 'PAT-09', label: 'Redaktions-Routing',
    trigger: 'Persona: P-RED erkannt — Nutzer ist Autor:in oder Redakteur:in',
    coreRule: 'Sofort und motivierend in den R-00-Autor:innen-Flow überleiten. Keinen eigenen Suchcontent generieren.',
    length: 'kurz',
    triggerSignals:  ['zielgerichtet', 'entscheidungsbereit'],
    triggerStates:   ['state-10'],
    triggerPersonas: ['P-RED'],
    triggerIntents:  ['INT-W-05'],
  },
  {
    id: 'PAT-10', label: 'Fakten-Bulletin',
    trigger: 'Persona: P-VER / P-BER · Intent: Faktenfragen, Analyse — zitierfähige Zahlen gefragt',
    coreRule: 'Bullet-Facts. Zitierfähig mit Quellenverweis. Kein Narrativ, keine Werbung. Max. 7 Punkte.',
    length: 'bullet-liste',
...

  {
    ...
    coreRule: 'Ein Konzept oder eine Aktion pro Antwort. Verständnisfrage am Ende einbauen. Kein Info-Overload.',
    length: 'mittel',
  ...
  },
  {
    ...
    coreRule: 'Aufbau: Befund → Zahlen/Belege → Handlungsempfehlung. Tabellarisch wenn möglich. Kein Fließtext.',
    length: 'bullet-liste',
  ...
  {
    id: 'PAT-16', label: 'Autor-Einladung',
    trigger: 'Persona: P-RED — Redakteur:in erkundigt sich vor oder statt Routing',
    coreRule: 'Mehrwert des Beitragens hervorheben (2 Sätze). Dann Hinweis auf R-00-Flow. Einladend, nicht drängend.',
    length: 'mittel',
    triggerSignals:  ['neugierig', 'vertrauend', 'zielgerichtet'],
    triggerStates:   ['state-1', 'state-3'],
    triggerPersonas: ['P-RED'],
    triggerIntents:  ['INT-W-05'],
  },
  {
    ...
    coreRule: '3 Einstiegswege anbieten (Suche, Themenseiten, Frage stellen). Keine Fachbegriffe. Warm und einladend.',
    length: 'normal',

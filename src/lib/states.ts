...
export const CONV_STATES: ConvState[] = [
  ...
  {
    id: 'state-10', label: 'Routing & Handover',
    description: 'Übergabe an anderen Flow (primär R-00-Flow für Redakteure)',
    cluster: 'C', clusterLabel: 'Abschluss & Sonder', emoji: '🛑',
    goal: 'Nutzer an richtigen Bereich weiterleiten',
    botFocus: 'Sofort weiterleiten. Motivierend formulieren. Kein eigener Content.',
    mainPersonas: ['P-RED'],
    tools: [],
    transitions: ['R-00-Flow (extern)'],
  },
  {
